"""
Django settings for django_SmartOps project.
...
SECRET_KEY = '+5n(k3z@o=)u3@g(g-dn$s!rnje-jw&q-l4pr!&f$p+9l_n#0o'
...
ROOT_URLCONF = 'django_SmartOps.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR+"/smartOps/templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'django_SmartOps.wsgi.application'
