...
tpl_path='/home/liujun/test/src/py/django_test/django_SmartOps/media/files/knowledge_input_tpl.xlsx'
...
# media/file/knowledge_input_tpl.xlsx
def media_file_download(request, file_path=tpl_path):
    '''
...
def file_response_download(request, file_path=tpl_path):
